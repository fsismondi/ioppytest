...
docker build -t testing_tool-interoperability-coap-v-0.7 .

# tag "HEAD" for INTEROP TESTING TOOL
docker tag testing_tool-interoperability-coap-v-0.7:latest testing_tool-interoperability-coap

# the testing tool for interop and conformance are the same
docker tag testing_tool-interoperability-coap-v-0.7:latest testing_tool-conformance-coap-v-0.7

# tag "HEAD" for CONFORMANCE TESTING TOOL
docker tag testing_tool-conformance-coap-v-0.7:latest testing_tool-conformance-coap
